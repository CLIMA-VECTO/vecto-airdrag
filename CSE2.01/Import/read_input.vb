...
Public Module read_input
    ...
    Public Function readInputVeh(ByRef vehicleX As cVehicle) As Boolean
        ...
        Dim FileInVehSpez As New cFile_V3
        ...
        ' Close the vehicle spezification file
        FileInVehSpez.Close()
    ...
    Function ReadInputMSC(ByRef MSCX As cMSC, ByVal MSCfile As String, Optional ByVal calibration As Boolean = True) As Boolean
        ...
        Dim Line() As String
        Dim FileInMSCSpez As New cFile_V3
    ...
    Public Function ReadWeather(ByVal Datafile As String) As Boolean
        ' Declaration
        Dim FileInWeather As New cFile_V3
        Dim Line() As String
    ...
    Public Function ReadDataFile(ByVal Datafile As String, ByVal MSCX As cMSC) As Boolean
        ' Declarations
        Dim FileInMeasure As New cFile_V3
